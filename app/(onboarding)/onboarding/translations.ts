...
export interface OnboardingStrings {
  ...
  s3: {
    ...
    currencyOptions: [string, string, string, string, string]
    dateFormatOptions: [string, string]
  }
...
const en: OnboardingStrings = {
  ...
  back: 'Back', continue: 'Continue', skip: 'Skip', getStarted: 'Get started', goToDashboard: 'Go to Dashboard', saving: 'Saving…',
...
const fr: OnboardingStrings = {
  ...
  back: 'Retour', continue: 'Continuer', skip: 'Passer', getStarted: 'Commencer', goToDashboard: 'Aller au tableau de bord', saving: 'Enregistrement…',
...
const de: OnboardingStrings = {
  ...
  back: 'Zurück', continue: 'Weiter', skip: 'Überspringen', getStarted: 'Loslegen', goToDashboard: 'Zum Dashboard', saving: 'Speichern…',
...
const es: OnboardingStrings = {
  ...
  back: 'Atrás', continue: 'Continuar', skip: 'Omitir', getStarted: 'Empezar', goToDashboard: 'Ir al panel', saving: 'Guardando…',
...
const it: OnboardingStrings = {
  ...
  back: 'Indietro', continue: 'Continua', skip: 'Salta', getStarted: 'Inizia', goToDashboard: 'Vai alla dashboard', saving: 'Salvataggio…',
...
const nl: OnboardingStrings = {
  ...
  back: 'Terug', continue: 'Doorgaan', skip: 'Overslaan', getStarted: 'Aan de slag', goToDashboard: 'Naar dashboard', saving: 'Opslaan…',
  ...
  s3: { heading: 'Waar is uw bedrijf gevestigd?', subtitle: 'Dit bepaalt uw btw-indeling, valuta en datumweergave.', countryLabel: 'Land / Regio', countryPlaceholder: 'Selecteer een land…', vatRate: 'Btw-tarief (%)', currency: 'Valuta', dateFormat: 'Datumnotatie', vatFormat: 'Formaat btw-nummer', vatHint: 'Vooraf ingevuld met het standaardformaat voor uw land. U kunt dit aanpassen.', requiredHint: 'Verplicht — dit beïnvloedt de btw-berekeningen in de hele app.', currencyOptions: ['EUR — Euro', 'GBP — Brits pond', 'SEK — Zweedse kroon', 'PLN — Poolse zloty', 'CHF — Zwitserse frank'], dateFormatOptions: ['DD/MM/JJJJ (Europees)', 'MM/DD/JJJJ (VS)'] },
